...
const SignUpForm = () => {
  ...
  return (
    <div className="w-[500px] shadow-lg overflow-hidden bg-white rounded-lg absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
      <div className="w-full px-4 py-2 ">
        <div className="text-center">
          <h1 className="text-2xl">Sign Up</h1>
          <p className="text-body mt-2">Get started with Prescribe Me</p>
        </div>
        <form action="#" className="mt-4">
          <div className="my-4">
            ...
            <input
              ...
              className="w-full rounded-md border-[1.5px] border-bodydark bg-transparent py-2 px-2 outline-none transition focus:border-green active:border-green disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
            />
          </div>
          <div className="my-4">
            <label className="mb-1 block text-black dark:text-white">
          ...
          <div className="flex justify-between items-center mb-6">
            <button
              type="submit"
              className="bg-green px-8 py-2 transition-three text-white rounded-md border-[1px] border-white hover:border-black"
            >
              Sign up
            </button>
          ...
          <p className="text-[0.8rem] text-bodydark2">
            We&apos;ve updated our terms to enhance your data security.{" "}
            <Link className="underline text-black">Click here</Link> to check
            our latest terms.
          </p>
        </form>
      </div>
